            ...
            $.ajax({
              ...
              success: function (output) {
                    ...
                    map.addMarker({
                      ...
                      animation: google.maps.Animation.DROP,                                       
                      infoWindow: {
                        content: '<p>Asset located at- lat: '+res[0]+' , lng: '+res[1]+' | veh:'+res[2]+'</p>'
                      }
                    });

                    document.getElementById('currcoordinates').innerHTML += "<div style=\"letter-spacing: 1px;margin : auto;padding:20px 10px 10px 10px;font-style: sans-serif;font-weight:bold\"><b>Lat: </b>"+res[0]+" | <b>Lng:</b> "+res[1]+"</div><br><div style=\"letter-spacing: 1px;margin : auto;padding:20px 10px 10px 10px;font-style: sans-serif;font-weight:bold\"><b>Vehicle:</b>"+res[2]+" </div>";  
                    ...
                    status = isInside;
                    if(!isInside){
                      document.getElementById('currcoordinates').innerHTML += "<div style=\"letter-spacing: 1px;margin : auto;padding:10px 10px 10px;font-style: sans-serif;font-weight:bold\">Asset is OUTSIDE defined bounds <i class=\"fa fa-times\" aria-hidden=\"true\"></i><br>----------------</br></div>" ;                    
                    }
                    else{
                      document.getElementById('currcoordinates').innerHTML += "<div style=\"letter-spacing: 1px;margin : auto;padding:10px 10px 10px;font-style: sans-serif;font-weight:bold\">Asset is INSIDE defined bounds <i class=\"fa fa-check\" aria-hidden=\"true\"></i><br>----------------</br></div>" ;
                    }
                    ...
                    map.addMarker({
                      ...
                      animation: google.maps.Animation.DROP,                                       
                      infoWindow: {
                        content: '<p>Asset located at- lat: '+res[3]+' , lng: '+res[4]+' | veh: '+res[5]+'</p>'
                      }
                    });


                   document.getElementById('currcoordinates').innerHTML += "<div style=\"letter-spacing: 1px;margin : auto;padding:20px 10px 10px 10px;font-style: sans-serif;font-weight:bold\"><b>Lat: </b>"+res[3]+" | <b>Lng:</b> "+res[4]+"</div><br><div style=\"letter-spacing: 1px;margin : auto;padding:20px 10px 10px 10px;font-style: sans-serif;font-weight:bold\"><b>Vehicle:</b>"+res[5]+" </div>";  
                     
                    

                    var isInside = map.checkGeofence(res[3],res[4], polygon);
                    status = isInside;
                    if(!isInside){
                      document.getElementById('currcoordinates').innerHTML += "<div style=\"letter-spacing: 1px;margin : auto;padding:10px 10px 10px;font-style: sans-serif;font-weight:bold\">Asset is OUTSIDE defined bounds <i class=\"fa fa-times\" aria-hidden=\"true\"></i><br>----------------</br></div>" ;                    
                    }
                     ...
                     map.addMarker({
                      ...
                      animation: google.maps.Animation.DROP,                                       
                      infoWindow: {
                        content: '<p>Asset located at- lat: '+res[6]+' , lng: '+res[7]+' | veh: '+res[8]+'</p>'
                      }
                    });


                   document.getElementById('currcoordinates').innerHTML += "<div style=\"letter-spacing: 1px;margin : auto;padding:20px 10px 10px 10px;font-style: sans-serif;font-weight:bold\"><b>Lat:</b> "+res[6]+" | <b>Lng:</b> "+res[7]+"</div><br><div style=\"letter-spacing: 1px;margin : auto;padding:20px 10px 10px 10px;font-style: sans-serif;font-weight:bold\"><b>Vehicle:</b>"+res[8]+" </div>";  
